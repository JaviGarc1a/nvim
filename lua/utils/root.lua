...
local function get_lsp_clients(buf)
	buf = type(buf) == "number" and buf or vim.api.nvim_get_current_buf()
...
local function info(lines, opts)
	vim.notify(table.concat(lines, "\n"), vim.log.levels.INFO, opts or {})
end
